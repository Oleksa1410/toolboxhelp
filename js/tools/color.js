export function renderColor(el, { copyText }) {
  el.innerHTML =
    ...
    '<input type="color" id="cpick" value="#00cca3" style="width:50px;height:38px;border-radius:6px;border:1px solid var(--border);background:transparent;cursor:pointer;padding:3px"></div>' +
    '<div class="field"><span class="f-label">HEX</span><input type="text" id="chex" value="#00cca3"></div>' +
    '<div class="field"><span class="f-label">R</span><input type="number" id="cr" value="0" min="0" max="255"></div>' +
    '<div class="field"><span class="f-label">G</span><input type="number" id="cg" value="204" min="0" max="255"></div>' +
    '<div class="field"><span class="f-label">B</span><input type="number" id="cb" value="163" min="0" max="255"></div>' +
    '</div></div>' +
